...
VERSION_PACKAGE=github.com/marmotedu/zblog/pkg/version
...
build: tidy # 编译源码，依赖 tidy 目标自动添加/移除依赖包.
	# @go build -v -o $(OUTPUT_DIR)/zblog $(ROOT_DIR)/cmd/zblog/main.go
	@go build -v -ldflags "$(GO_LDFLAGS)" -o $(OUTPUT_DIR)/zblog $(ROOT_DIR)/cmd/zblog/main.go
